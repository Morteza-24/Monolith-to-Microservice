...
parser = ArgumentParser(
    ...
    epilog='example usage: python hierarchical_DBSCAN_.py -f Test_Projects/JPetStore/OneFileSource.java --alpha 0.5 0.9 --epsilon 0.5 0.9 -e ICP NED -o output.json')
